...
// Lazy loading for participant components
const ParticipantDashboard = lazy(() => import("./components/participants/participantsDashboard"));
const CreateParticipantProfile = lazy(() => import("./components/participants/profile/CreatePartProfile"));
const EditParticipantProfile = lazy(() => import("./components/participants/profile/PartEditDetails"));
const CreateTeam = lazy(() => import("./components/participants/teams/TeamsPage"));
const ParticipantTeams = lazy(() => import("./components/participants/teams/TeamSubmissions"));
const TeamDetails = lazy(() => import("./components/participants/teams/soloTeam/ViewTeamDetails"));
const MakeHackathonSubmission = lazy(() => import("./components/hackathon/submitHackathon/SubmitHackathon"));
const EditHackathonSubmission = lazy(() => import("./components/hackathon/submitProject/UpdateSubmission"));
const InviteDetails = lazy(() => import("./components/participants/teams/ViewInviteDetails"));
const ViewTeamSubmission = lazy(() => import("./components/participants/teams/groupTeam/ViewSubmission"));
const ParticipantHackathons = lazy(() => import("./components/hackathon/hackathonDashboard/HackathonDashboard"));
const HackathonDetails = lazy(() => import("./components/hackathon/submitProject/HackathonDetailsPage"));
...
// Lazy loading for organizer components
const OrgDashboard = lazy(() => import("./components/organizers/OrgDashboard"));
const CreateOrgProfile = lazy(() => import("./components/organizers/profile/CreateOrgProfile"));
const OrgEditDetails = lazy(() => import("./components/organizers/profile/OrgEditDetails"));
const OrgOutlet = lazy(() => import("./components/organizers/OrgOutlet"));
const OrgHackathonPage = lazy(() => import("./components/organizers/OrgHackathonPage"));
const OrgViewProject = lazy(() => import("./components/organizers/OrgViewProject"));
const EditHackathon = lazy(() => import("./components/organizers/edithackathon/EditHackathon"));
const CreateHackathon = lazy(() => import("./components/organizers/createhackathon/CreateHackathon"));
const AddMedia = lazy(() => import("./components/hackathon/AddMedia"));
const HackathonMedia = lazy(() => import("./components/hackathon/HackathonMedia"));
const EmailValidation = lazy(() => import("./components/organizers/createhackathon/EmailValidation"));
const CodeVerification = lazy(() => import("./components/organizers/createhackathon/CodeVerification"));
const OrgSubmissionPage = lazy(() => import("./components/organizers/OrgSubmissionPage"));
const OrgSubmissions = lazy(() => import("./components/organizers/OrgSubmissions"));
const ViewDetailsPage = lazy(() => import("./components/organizers/ViewDetailsPage"));
...
const AllParticipants = lazy(() => import("./components/admin/participants/AllParticipants"));
const ParticipantProfile = lazy(() => import("./components/admin/participants/ParticipantProfile"));
const AllOrganizers = lazy(() => import("./components/admin/organizers/AllOrganizers"));
const AddHackMedia = lazy(() => import("./components/admin/organizers/AddHackMedia"));
const ViewHackathons = lazy(() => import("./components/admin/organizers/ViewHackathons"));
const ViewHackDetails = lazy(() => import("./components/admin/organizers/ViewHackDetails"));
const AllHackathons = lazy(() => import("./components/admin/hackathons/AllHackathons"));
const ViewHackathon = lazy(() => import("./components/admin/hackathons/ViewHachathon"));
const ViewHackDetail = lazy(() => import("./components/admin/hackathons/ViewHackDetail"));
const AllSubmissions = lazy(() => import("./components/admin/allSubmissions/AllSubmissions"));
const ViewSubmissions = lazy(() => import("./components/admin/allSubmissions/ViewSubmission"));
const EditSubmission = lazy(() => import("./components/admin/allSubmissions/EditSubmission"));
const DeleteSubmission = lazy(() => import("./components/admin/allSubmissions/DeleteSubmission"));
const GradingListTable = lazy(() => import("./components/admin/GradingListTable"));
...
const CreateTag = lazy(() => import("./components/admin/category/CreateCategory"));
const AllTeams = lazy(() => import("./components/admin/teams/AllTeams"));
const ViewTeam = lazy(() => import("./components/admin/teams/ViewTeam"));
const TeamSubmission = lazy(() => import("./components/admin/teams/TeamSubmission"));
const AllGrades = lazy(() => import("./components/admin/AllGrades"));
const CreateNotifications = lazy(() => import("./components/admin/notifications/CreateNotifications"));
            ...
            <Route element={<RequireAuth requiredRouteRole={"PARTICIPANT"} />}>
              <Route path="participant" element={<Sidebar />}>
                ...
                <Route path="teams-submissions" element={<Outlet />}>
                  ...
                  <Route path="update" element={<EditHackathonSubmission />} />
